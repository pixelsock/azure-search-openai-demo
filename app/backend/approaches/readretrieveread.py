...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"Assistant helps the users with their Charlotte Unified Developement Ordinance (UDO) questions." \
...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "usefull for retrieving information from the Charlotte Unified Developement Ordinance (UDO)."
